...
<html lang="ko" id="sub01_00">
   <head>
      <meta charset="utf-8">
	  <meta name="naver-site-verification" content="f946a7189a14a33c9955b5abaac57c29c11690c6" />
      ...
      <link rel="stylesheet" type="text/css" href="/css/${siteCode}/main.css?ver=20230221">
      ...
      <script type="application/ld+json">
			{
			 ...
			 "sameAs": [
			   "https://www.youtube.com/c/dangjincity",
			   "https://www.instagram.com/dangjincity/?hl=ko"
			 ]
			}
			</script>
...
<!--팝업창-->
<style type="text/css">
#popup{position:absolute;top:150px;left:10%;width: 500px; height:auto; background:#3d3d3d; color:#fff; text-align:center;border:2px solid #000;z-index: 20006}
#popup a{display:block;width: 100%;height: 100%;}
#popup2{position:absolute;top:150px;left:150px; width:454px; height:auto; background:#3d3d3d; color:#fff; text-align:center;border:2px solid #000;z-index: 20006}
#popup3{position:absolute;top:90px;left:560px; width:527px; height:auto; background:#3d3d3d; color:#fff; text-align:center;border:2px solid #000;z-index: 20006}
#popup3 a{display:block;width: 100%;height: 100%;}
/*#popup3 a:first-child{border-bottom:1px solid #3c6bb2;}*/
#popup4{position:absolute;top:90px;left:560px; width:515px; height:auto; background:#3d3d3d; color:#fff; text-align:center;border:2px solid #000;z-index: 20006}
...
#popup .popup_btn {position: absolute;bottom: 60px;left: 0;right: 0;margin: 0 auto;padding: 8px 20px;border-radius: 13px;background-color: #1b4b7b;font-size: 21px;color: #fff;font-weight: bold;width: 150px;height: 48px;display: inline-block;}

.popup_box img {width:100%;}

@media all and (max-width:1630px){
	/*#popup{width:35%;left:6%;top:20%;}*/
	#popup2{width:35%;left:6%;top:20%;}
	#popup3{width:35%;left:43%;top:20%;}
	#popup4{width:35%;left:43%;top:20%;}
}

@media all and (max-width:630px){
	#popup{width:90%;left:5%;top:20%;}
	#popup .popup_btn {bottom: 42px;width: 136px;height: 41px;font-size: 16px;}
	#popup2{width:90%;left:5%;top:35%;}
	#popup3{width:90%;left:5%;top:20%;}
	#popup4{width:90%;left:5%;top:20%;}
}
...
<div id="popup_wrap">
	<!-- <div id="popup">
		<div class="popup_box">
			<a href="http://corona19.dangjin.go.kr/corona19/index.do?menu=1" target="_blank" title="새창열림"><img src="/images/common/main/popup_5_6_new.png" border="0" alt="당진시 코로나19 발생현황 자세히보러가기" /></a>
			<a href="http://corona19.dangjin.go.kr/corona19/index.do?menu=2" target="_blank" title="새창열림"><img src="/images/common/main/popup_5_6_new2.png" border="0" alt="당진시 코로나19 확진자 이동경로 자세히보러가기" /></a>
			...
			<a href="/cop/bbs/BBSMSTR_000000000013/selectBoardArticle.do?nttId=1075550&kind=&mno=sitemap_12&pageIndex=1&searchCnd=&searchWrd=" target="_blank" title="새창열림"><img src="/images/common/main/popup_corona_20210117.jpg" border="0" alt="사회적거리두기 1.5단계 조치사항 자세히보러가기"></a>

			<div class="close_wrap">
				<form name="pop_form" id="pop_form">
					<div class="check">
						<label class="" for="popup_today1" >오늘 하루동안 보지 않기</label>
						<input type="checkbox" id="popup_today1" name="chkbox" value="checkbox">
					</div>
					<div class="close" style="margin:0 0 0 20px;">
						<a href="javascript:closePop('popup', 'pop_form');">CLOSE</a>
					</div>
				</form>
			</div>
		</div>
	...
	<div id="popup" data-expired="2022-09-24 23:59">
		<div class="popup_box">
			<a href="/cop/bbs/BBSMSTR_000000000016/selectBoardArticle.do?nttId=1089179" title="새창열림">
				<img src="/images/kor/new_main/popup_20220901.jpg" border="0" alt="팝업 이미지: 제28회 충청남도 장애인체육대회 (클릭시 상세페이지로 넘어갑니다.)" />
			</a>
	...
	<!--<div id="popup2">
		<div class="popup_box">
			<a href="/viewer/skin/doc.html?fn=BBS_202109170230509410.pdf&rs=/viewer/result/BBSMSTR_000000000450/" target="_blank" title="새창열림">
			    <img src="/images/common/main/popup_20210917.jpg" border="0" alt="당진시 폭력예방상담소가 제안하는 함께해서 행복한 추석"/>
		   </a>
			...
			<div class="close_wrap">
				<form name="pop2_form" id="pop2_form">
					<div class="check">
						...
						<input type="checkbox" id="popup_today2" name="chkbox" value="checkbox">
					</div>
	...
	<!-- <div id="popup3">
		<div class="popup_box">
			<a href="https://forms.gle/fMLzBWirwoSqsshU7" target="_blank" title="새창열림">
			    <img src="/images/common/main/popup_20210819.jpg" border="0" alt="2021년 당진시 공공데이터 수요조사"/>
		   </a>
			
			<div class="close_wrap">
				<form name="pop3_form" id="pop3_form">
					<div class="check">
						<label class="" for="popup_today3" >오늘 하루동안 보지 않기</label>
						<input type="checkbox" id="popup_today3" name="chkbox" value="checkbox">
					</div>
					<div class="close" style="margin:0 0 0 20px;"><a href="javascript:closePop('popup3', 'pop3_form');">CLOSE</a></div>
				</form>
			</div>
		</div>
	</div> 
			...
			<div class="close_wrap">
				<form name="pop4_form" id="pop4_form">
					<div class="check">
						...
						<input type="checkbox" id="popup_today4" name="chkbox" value="checkbox">
					</div>
...
<script type="text/javascript">
    ...
    // {   
    //     document.all['popup5'].style.visibility = "visible";
    // }else {
    //     document.all['popup5'].style.visibility = "hidden";
    // } 	
   ...
   <body>
      	...
      	<div class="skin_bg">
      		<div class="inner">
      			<div class="spring_wrap">
      				<div class="spring_left"></div>
      				<div class="spring_right"></div>
      				<div class="spring_bg"></div>
      				<div class="spring_bicycle_ani">
      					<img src="/images/kor/new_main/skin/skin_spring_bicycle.png" alt="자전거">
      				</div>
      			</div>
      		</div>
      	</div>
      	<script src="/js/kor/sakura.js"></script>
      	<link rel="stylesheet" type="text/css" href="/css/kor/sakura.css">
      	<script>
      		var sakura = new Sakura('.spring_bg', {
      			colors: [
      			{
	  ...
	  <!-- 여름 스킨 :: Start -->
	  	<!-- <div class="skin_bg">
	  		<div class="inner">
	  			...
	  			<div class="bg_obj obj02"></div>

	  			<div class="bg_obj photo_wrap">
	  				<div class="photo">
	  					<div class="obj1"></div>
	  					<div class="obj2"></div>
	  					<div class="obj3"></div>
		...
		<!-- <div class="skin_bg">
		  <div class="inner">
			<div class="autumn_wrap">
				<div class="autumn_left">
					<img class="obj-01" src="/images/kor/new_main/skin/skin_autumn_obj_left_01.png" alt="잠자리">
					<img class="obj-02" src="/images/kor/new_main/skin/skin_autumn_obj_left_02.png" alt="잠자리">
				</div>
				<div class="autumn_right">
					<img class="obj-03" src="/images/kor/new_main/skin/skin_autumn_obj_right.png" alt="열기구">
				</div>
				<div class="autumn_bg"></div>
			</div>
		  </div>
	  	</div>
		<script src="/js/kor/sakura.js"></script>
		<link rel="stylesheet" type="text/css" href="/css/kor/sakura.css">
		<script>
		  var sakura = new Sakura('.autumn_bg', {
			colors: [
			  {
				gradientColorStart: 'rgba(245, 209, 171, 0.9)',
				gradientColorEnd: 'rgba(246, 215, 181, 0.9)',
				gradientColorDegree: 120,
			  },
			  {
				gradientColorStart: 'rgba(248,202,154)',
				gradientColorEnd: 'rgba(234,190,143)',
				gradientColorDegree: 120,
			  },
			  {
				gradientColorStart: 'rgba(217,180,140)',
				gradientColorEnd: 'rgba(237,201,162)',
				gradientColorDegree: 120,
			  },
			],
			delay: 300,
		...
		<div id="container">
			...
			<div id="controlTab">
				<ul style="position: relative">
					...
					<li id="life_btn"><a href="#none" class="life">경제</a></li>
					<li id="admin_btn" class="on"><a href="#none" class="admin">행정</a></li>
					<li id="civil_btn"><a href="#none" class="civil">환경</a></li>
			...
			<div>
				...
				<div id="admin" class="on">
					...
					<div class="ti">
						<h2>
						<svg height="50" width="100" focusable="false">
						   <defs>
					...
					<div class="box">
						...
						<div class="con1">
							<div class="pZone">
								<ul class="control">
									...
									<li><a href="#" class="is stop topPzoneStop" id="btnCon1">멈춤</a></li>
						...
						<div class="con2">
							<div>
								<h3>자주찾는 행정</h3>
								<ul>
									<li class="ico1"><a href="/kor/sub04_04_07.do" target="_blank">청사안내</a></li>
								...
								<div class="table">
									<div class="table-row">
										...
										시민정보화교육</a>
										<a href="/kor/sub05_06_01_01.do" class="table-col">전입시민 생활안내서</a>
									</div>
									<div class="table-row">
										<a href="http://corona19.dangjin.go.kr/corona19/" class="table-col">코로나19</a>
										<a href="/kor/sub01_01_03_01.do" class="table-col">무인민원발급기</a>
									</div>
									<div class="table-row">
										<a href="/kor/sub01_01_14.do" class="table-col">수요야간민원신청</a>
										<a href="/kor/sub01_01_15.do" class="table-col">무료법률상담신청</a>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="con3">
							<div class="mayor">
								<div class="titlebox">
									<a href="/mayor/index.html" target="_blank"  title="새창열림">함께여는 미래, 생동하는 당진. 당진시장 오성환입니다.</a>
									<a href="/mayor/index.html" target="_blank"  title="새창열림">함께여는 미래, 생동하는 당진. 당진시장 오성환입니다.</a>
								</div>

								<div class="mayor_btn_wrap">
									<div class="mayor_btn">
										<a href="/mayor/html/sub01/0101.html" target="_blank" title="새창열림">인사말</a>
									</div>
									<div class="mayor_btn">
										<a href="http://www.dangjin.go.kr/mayor/html/sub03/0301.html" target="_blank" title="새창열림">공약과 실천</a>
									</div>
									<div class="mayor_btn">
										<a href="https://www.dangjin.go.kr/prog/poll/kor/sub02_11/list.do" target="_blank" title="새창열림">설문조사</a>
									</div>
									<div class="mayor_btn">
										<a href="http://www.dangjin.go.kr/kor/sub02_03_02_01.do" target="_blank" title="새창열림">정책제안</a>
									</div>
									<div class="mayor_btn">
										<a href="http://www.dangjin.go.kr/kor/sub01_04_01_01.do" target="_blank" title="새창열림">시장에게 바란다</a>
									</div>
									<!-- <div class="mayor_btn">
										<a href="/mayor/html/sub03/0301.html" target="_blank" title="새창열림">공약(매니페스토)</a>
									</div> -->
								</div>
							</div>
						</div>
					...
					<div class="box">
						...
						<div class="con1">
							<div class="pZone">
								<ul class="control">
									<li><a href="#" class="is prev topPzonePrev" >이전</a></li>
									<li><a href="#" class="is stop topPzoneStop" id="btnCon2">멈춤</a></li>
									<li><a href="#" class="is next topPzoneNext">다음</a></li>
								</ul>
								<div class="list">
									<ul>
						...
						<div class="con2">
							<div>
								<h3>자주찾는 환경정보</h3>
								<ul>
									<li class="ico1"><a href="/prog/waitingPollutn/kor/sub05_09_05/list.do">실시간대기오염도</a></li>
									<li class="ico2"><a href="/kor/sub05_09_07_01.do">생활폐기물 배출안내</a></li>
									<li class="ico3"><a href="/kor/sub05_09_06.do">탄소포인트제</a></li>
								</ul>
								<div class="table">
									<div class="table-row">
										<a href="/kor/sub05_09_14.do" class="table-col">재활용품수거 자판기</a>
										<a href="/kor/sub05_09_08.do" class="table-col">정화조 청소 안내</a>
									</div>
									<div class="table-row">
										<a href="/kor/sub05_09_01.do" class="table-col">환경보전종합계획</a>
										<a href="/kor/sub05_09_03_01.do" class="table-col">환경기초시설</a>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="con3">
							<div>
								<a href="/cop/bbs/BBSMSTR_000000000660/selectBoardList.do" target="_blank" title="새창열림"><img src="/images/kor/new_main/con2_banner01.jpg?ver=20221219" alt="현안사업 설명자료 당진시 현안에 대한 설명자료를 안내합니다. 바로가기" /></a>
							</div>
						</div>
					...
					<div class="box">
						...
						<div class="con1">
							<div class="pZone">
								<ul class="control">
									<li><a href="#" class="is prev topPzonePrev" >이전</a></li>
									<li><a href="#" class="is stop topPzoneStop" id="btnCon3">멈춤</a></li>
									<li><a href="#" class="is next topPzoneNext">다음</a></li>
								</ul>
								<div class="list">
									<ul>
						...
						<div class="con2">
							<div>
								<h3>자주찾는 경제정보</h3>
								<ul>
									<li class="ico1"><a href="/kor/sub05_03_01_01.do">기업 지원</a></li>
									<li class="ico2"><a href="/kor/sub05_03_03_01.do">소상공인 지원</a></li>
									<li class="ico3"><a href="/kor/sub05_03_10_01.do">일자리 지원</a></li>
								</ul>
								<div class="table">
									<div class="table-row">
										<a href="/kor/sub05_03_04_01.do" class="table-col">소비자 보호</a>
										<a href="/kor/sub05_03_09_01.do" class="table-col">근로자 권익보호</a>
									</div>
									<div class="table-row">
										<a href="/kor/sub05_03_05_01.do" class="table-col">당진사랑상품권</a>
										<a href="/kor/sub05_03_10_02.do" class="table-col">일자리센터</a>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="con3">
							<div class="autoplay3">
								<div>
									<img src="/images/kor/new_main/enterprise_01.jpg" alt="1.당진시 미래성장동력 사업-철강산업 고도화 첨단금속소재산업 초정밀기술지원 플랫폼" />
								</div>
								<div>
									<img src="/images/kor/new_main/enterprise_02.jpg" alt="2.당진시 미래성장동력 사업-에너지산업 미래에너지 융복합 혁신벨트 조성" />
								</div>
								<div>
									<img src="/images/kor/new_main/enterprise_03.jpg" alt="3.당진시 미래성장동력 사업-산업단지조성 RE100 산업단지" />
								</div>
							</div>
							<div class="mvis_control ctrl3">
			...
			<section class="con4">
				<div class="siteLink_inner">
					...
					<div class='autoplay'>		  	
						<div class="ico1">
							<a href="https://shimhoon.dangjin.go.kr" target="_blank" title="새창열림">심훈기념관</a>
						</div>
						<div class="ico2">
							<a href="https://beogeunae.dangjin.go.kr" target="_blank" title="새창열림">버그내순례길</a>
						</div>
						<div class="ico3">
						...
						<div class="ico15">
							<a href="https://www.redwhistle.org/report/report.asp?organ=450&RType=1" target="_blank" title="새창열림">반부패 익명신고</a>
						</div>
						<div class="ico18">
							<a href="https://ncp.clean.go.kr/cmn/secCtfcKMC.do?menuCode=acs&amp;mapAcs=Y&amp;insttCd=5680000" target="_blank" title="새창열림">부패공익신고</a>
						</div>
						<div class="ico16">
							<a href="https://www.dangjin.go.kr/sos-center.do" target="_blank" title="새창열림">당진시폭력예방<br>상담소</a>
						</div>
						<div class="ico17">
							<a href="https://www.dangjin.go.kr/lib.do" target="_blank" title="새창열림">시립도서관</a>
						</div>
					</div>
			...
			<!--게시판 -->
			  ...
			  <div class="mlnk">
				  <ul>
					...
					<li><a href="https://www.open.go.kr/" target="_blank" title="새창열림" class="ico3"><span>정보공개</span></a>
						<a href="https://www.dangjin.go.kr/prog/ioCateData/kor/sub03_05_04/list.do" class="ico3"><span>사전정보공표</span></a>
					</li>
				  </ul>
			  </div>
			  <!-- //바로가기 -->
	  ...
	  <div id="conF">
	  	<div class="layout">
	  			<div class="pc_chat">
	  				<a href="http://pf.kakao.com/_xfQbTb" target="_blank" title="카카오톡 채팅상담 PC용 새창열림">
	  					<img src="/images/kor/new_main/kakao_pc.jpg" alt="당진시 민원콜센터 카카오톡 채팅상담 바로가기 PC용">
	  				</a>
	  			</div>
	  			<div class="mo_chat">
	  				<a href="http://pf.kakao.com/_xfQbTb/chat" target="_blank" title="카카오톡 채팅상담 모바일용 새창열림">
	  					<img src="/images/kor/new_main/kakao_mo.jpg" alt="당진시 민원콜센터 카카오톡 채팅상담 바로가기 모바일용">
	  				</a>
	  			</div>
	  	</div>
	  </div>
		...
		<div class="layout">
			...
			<div class="ti">
				<h2>
					...
					<svg height="50" width="205" focusable="false">
					   <defs>
					   ...
					   <text fill="url(#grad4)" font-family="BRBA" x="5" y="40" style="font-family:'BRBA'">
						플러그인당진
						</text>
					</svg> 
				
				</h2>
				<span><a href="https://www.dangjin.go.kr/media/Main" target="_blank" title="소셜정책포털 새창열림">소셜정책포털</a></span>
			</div>
			...
			<ul class="link">
				...
				<li><a href="https://pf.kakao.com/_TuxiBxb" target="_blank" title="당진시청 카카오톡 채널 새창열림" class="sns_ico ico5">kakao</a></li>
	...
	<!--</div> -->
      ...
      <section id="slider_banner" class="banner_wrap">
		...
		<!-- Modal document -->
		<div id="ex1" tabindex="0" class="modal" role=dialog data-popup="ex1">
		  <h2 class="ti" tabindex="0" id="extabindex">패밀리누리집</h2>
			...
			<div class="conbox">
				<div class="listbox">
					<ul class="">
						...
						<li><a href="https://www.dangjin.go.kr/sos-center.do" target="_blank" title="새창">당진시폭력예방상담소</a></li>
					</ul>
				</div>
				<!-- //.listbox -->
				...
				<div class="listbox">
					<ul class="">
						...
						<li><a href="https://esdc.dangjin.go.kr" target="_blank" title="새창">개발부담금가산정시스템</a></li>
					</ul>
				</div>
				<!-- //.listbox -->
				...
				<div class="listbox">
					<ul class="">
						...
						<li><a href="http://www.dangjin.go.kr/fmres/" target="_blank" title="새창">당진시 통합예약시스템</a></li>
		...
		<div class="sitebox"><a href="#ex1" rel="modal:open" aria-haspopup="dialog" data-popup="ex1"><span>패밀리누리집</span></a></div>
		...
		<script>
			$('.sitebox a').click(function(event) {
			  ...
			  $("#ex1").attr("tabindex", 0).show().focus();
			  $("#extabindex").attr("tabindex", 0).show().focus();
			  //document.getElementById("#extabindex").focus();
			...
			<div class="finfo">
				<div class="footer_menu">
					<ul>
						...
						<li><a href="/gonet/FileDownload.do?fileName=dangjin_network.pdf&code=download" title="다운로드">행정전화번호부</a></li>
			 ...
			 <!--웹 접근성 품질인증 마크-->
			<!--<p class="mark"><a href="http://www.webwatch.or.kr/Situation/WA_Situation.html?MenuCD=110" title="국가 공인 인증기관 : 웹와치" target="_blank"><img src="/images/kor/new_common/wa_mk.jpg" alt="과학기술정보통신부 WEB ACCESSIBILITY 마크(웹 접근성 품질인증 마크)"></a></p>-->
			<p class="mark"><a href="http://www.webwatch.or.kr/Situation/WA_Situation.html?MenuCD=110" title="국가 공인 인증기관 : 웹와치" target="_blank"><img src="/images/kor/new_common/wa_mark.png" alt="과학기술정보통신부 WA(WEB접근성) 품질인증 마크, 웹와치(WebWatch) 2022.12.23. ~ 2023.12.22" title="WA 품질인증 마크, 웹아치(WebWatch) 2022.12.23. ~ 2023.12.22"></a></p>
				...
				<div>
					<div>
						...
						<ul class="obj">
							...
							<li><a href="https://cnc.cacf.or.kr/main/" target="_blank" title="충남문화포털,새창으로 이동합니다.">충남문화포털</a></li>
						</ul>
					</div>
...
<script type="text/javascript">
  $(document).ready(function(){
		...
		$('#slider_banner .grap .obj').slick({
		  ...
		  autoplay: false,
		  arrows: true,
		  prevArrow: $('#slider_banner .control .prev'),
		  nextArrow: $('#slider_banner .control .next'),
		  dots: false,
...
<script type="text/javascript">
  $(document).ready(function(){
	$('.autoplay3').slick({
	  ...
	  prevArrow: $('.ctrl3 .mvis_prev'),
	  nextArrow: $('.ctrl3 .mvis_next'),
	  dots: false
	});
	/* $('.ctrl3 .mvis_ctr').click(function(){
		$(this).css({display: 'none'}).siblings('.ctrl3 .mvis_ctr').css({display: 'inline-block'});
		if ($(this).hasClass('mvis_stop')) {
			tar.slick('slickPause');
		} else {
			tar.slick('slickPlay');
...
<script>
	...
	var today = year+''+month+''+day+''+time;
	   //today = '2014052500';  
	if('2022052100' <= today && today <= '2022060118' ) {
