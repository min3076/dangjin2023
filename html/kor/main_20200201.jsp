					...
					<div class="box">
						...
						<div class="con2">
							<div>
								<h3>자주찾는 행정정보</h3>
								<ul>
									<li class="ico1"><a href="/cyber/hall/">청사안내</a></li>
								...
								<div class="table">
									<div class="table-row">
										<a href="/synapsoft/FileViewer.do?atchFileId=FILE_000000001044018&fileSn=0" target="_blank" title="새창열림" class="table-col">당찬 당진살이</a>
						...
						<div class="con3">
							<div class="mayor">
								...
								<ul class="mayor_lnk">
									...
									<!--<li><a href="http://www.dangjin.go.kr/mayor/html/sub04/040304.html" target="_blank" title="새창열림">공약이행현황</a></li>-->
						...
						<div class="con2">
							<div>
								...
								<div class="table">
									...
									<div class="table-row">
										<a href="/synapsoft/FileViewer.do?atchFileId=FILE_000000001044018&fileSn=0"  target="_blank" title="새창열림" class="table-col">전입생활안내서</a>
										<a href="/prog/reprsntInfrmEdu/kor/sub05_11_01/list.do" class="table-col">시민정보화교육</a>
									</div>
								</div>
							</div>
						</div>
