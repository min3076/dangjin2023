...
<!--팝업창-->
<style type="text/css">
#popup{position:absolute;top:90px;left:70px;width:640px; height:auto; background:#3d3d3d; color:#fff; text-align:center;border:2px solid #000;z-index: 20006}
#popup a{display:block;width: 100%;height: 100%;}
#popup a:first-child{border-bottom:1px solid #3c6bb2;}
#popup2{position:absolute;top:90px;left:70px; width:465px; height:auto; background:#3d3d3d; color:#fff; text-align:center;border:2px solid #000;z-index: 20006}
...
-->
	...
	<!--
	 <div id="popup">
		<div class="popup_box">
			<img src="/images/common/main/popup_20210506.jpg" border="0" />
...
-->
	...
	<div id="popup2" data-expired="2021-08-22 23:59">
		<div class="popup_box">
			<a href="https://www.kimdaegeon.com/" target="_blank" title="새창열림">
			<img src="/images/common/main/popup_20210708.jpg" border="0" alt="김대건신부 탄생 200주년 행사 팝업" /></a>
				...
				<div id="life" class="off">
					...
					<div class="box">
						...
						<div class="con3">
							<div class="autoplay3">
								<div>
									<img src="/images/kor/new_main/enterprise_01.jpg" alt="" />
								</div>
								<div>
									<img src="/images/kor/new_main/enterprise_02.jpg" alt="" />
								</div>
								<div>
									<img src="/images/kor/new_main/enterprise_03.jpg" alt="" />
								</div>
							</div>
