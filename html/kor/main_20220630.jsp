...
<!--팝업창-->
<style type="text/css">
#popup{position:absolute;top:150px;left:10%;width:624px; height:auto; background:#3d3d3d; color:#fff; text-align:center;border:2px solid #000;z-index: 20006}
...
<!--
	<div id="popup">
		<div class="popup_box">
			<img src="/images/common/main/popup_20220114.jpg" border="0" alt="소기업·소상공인 방역물품지원금 신청하기 1차 신청기간: 2022년 1월 17일 월요일부터 2월 6익 일요일까지 최대 10만원 지급. 중소벤처기업부" />
			<a class="popup_btn" href="http://naver.me/IDbgozsx" target="_blank" title="새창열림">바로가기</a>
   ...
   <body>
			...
			<div>
				...
				<div id="civil" class="off">
					...
					<div class="box">
						...
						<div class="con3">
							<div>
								<a href="/cop/bbs/BBSMSTR_000000000660/selectBoardList.do" target="_blank" title="새창열림"><img src="/images/kor/new_main/con2_banner01.jpg" alt="현안사업 설명자료 당진시 현안에 대한 설명자료를 안내합니다. 바로가기" /></a>
							</div>
						</div>
	...
	<!--</div> -->
      ...
      <section id="slider_banner" class="banner_wrap">
		...
		<div class="sitebox"><a href="#ex1" rel="modal:open"><span>패밀리누리집</span></a></div>
