...
<div class="box_dept">
	...
	<div class="tab">
		<div> 
			...
			<a href="/kor/sub04_04_05_08.do?partCode=03" class="tab_ov">체육진흥과<i></i></a>
	...
	<div class="grep"> 
		<div class="obj"><!--자치행정과--> <c:import url="/prog/deptPerson/5680330/listDirect.do" charEncoding="utf-8" /></div>
	</div>
</div>
