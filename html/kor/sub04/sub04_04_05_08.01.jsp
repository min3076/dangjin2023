...
<div class="box_dept">
	...
	<div class="tab">
		<div> 
			...
			<a href="/kor/sub04_04_05_08.do?partCode=01" class="tab_ov">평생학습과<i></i></a>
	...
	<div class="grep"> 
		<div class="obj"><!--자치행정과--> <c:import url="/prog/deptPerson/5680328/listDirect.do" charEncoding="utf-8" /></div>
	</div>
</div>
