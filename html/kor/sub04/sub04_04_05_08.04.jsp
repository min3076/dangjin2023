...
<div class="box_dept">
	...
	<div class="tab"> 
		<div>
			...
			<a href="/kor/sub04_04_05_08.do?partCode=04" class="tab_ov">여성가족과<i></i></a>
			<a href="/kor/sub04_04_05_08.do?partCode=05">경로장애인과<i></i></a>
		</div>
	</div>

	<div class="grep"> 
		<div class="obj"><!--자치행정과--> <c:import url="/prog/deptPerson/5680331/listDirect.do" charEncoding="utf-8" /></div>
	</div>
</div>
