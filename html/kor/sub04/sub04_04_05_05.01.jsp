...
<div class="box_dept">
	...
	<div class="tab"> 
		...
		<a href="/kor/sub04_04_05_05.do?partCode=01" class="tab_ov">안전총괄과</a>
	...
	<div class="grep"> 
		<div class="obj"><!--자치행정과--> <c:import url="/prog/deptPerson/5680283/listDirect.do" charEncoding="utf-8" /></div>
	</div>
