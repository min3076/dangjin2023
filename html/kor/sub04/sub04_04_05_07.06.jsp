...
<div class="box_dept">
	...
	<div class="tab"> 
		<div>
			...
			<a href="/kor/sub04_04_05_07.do?partCode=01">도시과</a>
			...
			<a href="/kor/sub04_04_05_07.do?partCode=06" class="tab_ov">토지관리과</a>
	...
	<div class="grep"> 
		<div class="obj"><!--자치행정과--> <c:import url="/prog/deptPerson/5680305/listDirect.do" charEncoding="utf-8" /></div>
	</div>
</div>
