...
<div class="box_dept">
	...
	<div class="tab"> 
		<div>
			...
			<a href="/kor/sub04_04_05_08.do?partCode=02" class="tab_ov">사회복지과<i></i></a>
			<a href="/kor/sub04_04_05_08.do?partCode=03">체육진흥과<i></i></a>
			<a href="/kor/sub04_04_05_08.do?partCode=04">여성가족과<i></i></a>
			<a href="/kor/sub04_04_05_08.do?partCode=05">경로장애인과<i></i></a>
		</div>
	</div>

	<div class="grep"> 
		<div class="obj"><!--자치행정과--> <c:import url="/prog/deptPerson/5680329/listDirect.do" charEncoding="utf-8" /></div>
	</div>
</div>
