...
%>
 ...
 <style>
	#popup{position:absolute;top:409px;right:689px;width:546px; height:295px; background:#3d3d3d; color:#fff; text-align:center;border:2px solid #000;z-index: 20006}
	#popup .popup_box{width:100%;height:267px;}
	.close div{float:left; text-align:right;}
	.check{font-size:12px;font-family:'돋움';padding-left:10px;}
	.close{font-size:12px;padding:1px; font-weight:bold;}	
...
<div id="popup">
	<div class="popup_box">
		<img src="/images/kor/new_main/popup01.jpg" width="546" height="260" usemap="#Map20170904" border="0" />
		</div>
		<div class="close">
			<form name="pop_form">
				<div class="check"><input type="checkbox" name="chkbox" value="checkbox">오늘 하루동안 보지 않기</div>
				<div class="close" style="margin:0 0 0 20px;"><a href="javascript:closePop('popup');">CLOSE</a></div>
			</form>
		</div>
	</div>
</div>
...
<script  type="text/javascript">
	...
	if ( cookiedata.indexOf("popup=done") < 0 ){ //popup 1
						...
						<div class="con4">
							<div class="siteLink_inner">
								...
								<div class='autoplay'>		  	
									...
									<div class="ico2">
										<a href="https://www.dangjin.go.kr/beogeunae" target="_blank" title="새창열림">버그네순례길</a>
									</div>
									<div class="ico3">
									...
									<div class="ico4">
										<a href="https://www.dangjin.go.kr/cop/bbs/BBSMSTR_000000000330/selectBoardList.do" title="새창열림">재정공시</a>
									</div>
								 </div>
						...
						<div class="con2">
							<div>
								...
								<div class="table">
									...
									<div class="table-row">
										<a href="/synapsoft/FileViewer.do?atchFileId=FILE_000000001044018&fileSn=0" target="_blank" title="새창열림" class="table-col">
										전입생활안내서</a>
										<a href="/synapsoft/FileViewer.do?atchFileId=FILE_000000001051485&fileSn=0" target="_blank" title="새창열림" class="table-col">당찬 당진살이</a>
									</div>
								</div>
							</div>
						</div>
	  ...
	  <div id="conE">
		<div class="layout">
			...
			<div class='autoplay2'>		  	
				...
				<div class="ico11">
					<a href="/kor/sub05_09_01.do" target="_blank" title="새창열림">환경/청소/위생</a>
				</div>
				<div class="ico12">
				...
				<div>
					<div>
						...
						<ul class="obj">
							...
							<li><a href="http://www.cndje.go.kr/Good/main.php" target="_blank" title="당진교육지원청,새창으로 이동합니다.">당진교육지원청</a></li>
							...
							<li><a href="http://dangjincci.korcham.net/main.cci" target="_blank" title="당진상공회의소,새창으로 이동합니다.">당진상공회의소</a></li>
							<li><a href="http://dangjin.nfcf.or.kr/" target="_blank" title="당진시산림조합,새창으로 이동합니다.">당진시산림조합</a></li>
							<li><a href="http://www.djlc.co.kr/djlc/" target="_blank" title="당진축산업현동조합,새창으로 이동합니다.">당진축산업현동조합</a></li>
							...
							<li><a href="http://www.naqs.go.kr/cn/" target="_blank" title="국립농산물품질관리원[충남지원],새창으로 이동합니다.">국립농산물품질관리원[충남지원]</a></li>
						</ul>
					</div>
