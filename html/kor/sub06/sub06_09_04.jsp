...
<script src="//dapi.kakao.com/v2/maps/sdk.js?appkey=b476729042a77d97c951b8eb6afdac27" type="text/javascript"></script><script charset="UTF-8" src="http://s1.daumcdn.net/svc/attach/U03/cssjs/mapapi/3.5.11/1481522929979/open.js"></script>
		<script type="text/javascript">
			window.onload = function() {
				var position = new daum.maps.LatLng( 36.845774, 126.714597 );
...
<div class="view_info sub06_topbx">
	<div class="l_img"><img src="/images/kor/sub06/sub06_img08.jpg" alt="순성면 행정복지센터 전경"></div>
	<div class="rbgw">
		<div class="bbg">
			<span class="baricon"></span>
			<h2>순성면 사무소</h2>
			<ul>
				<li><span>주소 :</span> [31757] 충청남도 당진시 순성면<br>순성로 535</li>
				<li><span>전화번호 :</span> 041)360-8401~2</li>
			</ul>
		</div>
		<div class="gbg">
			<p><a href="http://kko.to/XsvObWFjB" target="_blank" title="새창열림">다음길찾기</a></p>
		</div>
	</div>
</div>
