...
<!--팝업창-->
<style type="text/css">
#popup{position:absolute;top:250px;left:50px; width:704px; height:auto; background:#3d3d3d; color:#fff; text-align:center;border:2px solid #000;z-index: 20006}
#popup2{position:absolute;top:250px;left:780px; width:704px; height:auto; background:#3d3d3d; color:#fff; text-align:center;border:2px solid #000;z-index: 20006}
#popup3{position:absolute;top:740px;left:780px; width:704px; height:auto; background:#3d3d3d; color:#fff; text-align:center;border:2px solid #000;z-index: 20006}
#popup4{position:absolute;top:949px;left:780px; width:704px; height:auto; background:#3d3d3d; color:#fff; text-align:center;border:2px solid #000;z-index: 20006}
...
@media all and (max-width:1560px){
	#popup{width:50%;left:10%;top:10%;}
	#popup2{width:50%;left:40%;top:10%;}
	#popup3{width:50%;left:40%;top:52%;}
	#popup4{width:50%;left:40%;top:62%;}
}

@media all and (max-width:600px){
	#popup{width:90%;left:5%;top:10%;}
	#popup2{width:90%;left:5%;top:36%;}
	#popup3{width:90%;left:5%;top:50%;}
...
<div id="popup_wrap">
	...
	<div id="popup">
		<div class="popup_box">
			<img src="/images/common/main/popup_5_6_new.jpg" border="0" />
		
		<div class="close_wrap">
			<form name="pop_form" id="pop_form">
				<div class="check"><input type="checkbox" name="chkbox" value="checkbox">오늘 하루동안 보지 않기</div>
	...
	<div id="popup2">
		<div class="popup_box">
			<img src="/images/common/main/popup_incheon_new１.jpg" border="0" />
	...
	<div id="popup3">
		<div class="popup_box">
			<img src="/images/common/main/popup_gunpo１.jpg" border="0" />
	...
	<div id="popup4">
		<div class="popup_box">
			<img src="/images/common/main/popup_cheonan1.jpg" border="0" />
   ...
   <body>
      ...
      <div id="conB">
		  ...
		  <div class="inner">
			...
			<div class="bg_obj photo_wrap">
			  <div class="photo">
				<div class="obj1"></div><!-- 사진찍는사람 -->
				<div class="obj2"></div><!-- 플래시 -->
				<div class="obj3"></div><!-- 새빛왜목 -->
				<div class="obj4"></div><!-- 수영1 -->
			  </div>
			</div>

			<div class="bg_obj left_wrap">
			  <div class="lbox">
				<div class="obj1"></div><!-- 배 -->
				<div class="obj2"></div><!-- 수영2 -->
				<div class="obj3"></div><!-- 파라솔 -->
			  </div>
			</div>
		...
		<div id="snowman"></div> 
		  ...
		  <script>
			var slide = bodymovin.loadAnimation({
				  container: document.getElementById('slide'), 
				  renderer: 'svg',
				  loop: true,
				  autoplay: true,
				  path: '/images/kor/new_main/animation/slide.json'
			});

			var snowman = bodymovin.loadAnimation({
				  container: document.getElementById('snowman'),
				  renderer: 'svg',
				  loop: true,
				  autoplay: true,
				  path: '/images/kor/new_main/animation/snowman.json' 
			});
			</script>
		<!-- animation -->
			...
			<div>
						...
						<div class="con2">
							<div class="corona">
								...
								<div class="box">
									...
									<ul class="list">
										<li>
											<p class="title">격리(치료)중</p>
											<p class="cont type1">2 명</p>
										</li>
										<li>
											<p class="title">격리해제(퇴원)</p>
											<p class="cont">4 명</p>
										</li>
									</ul>
				...
				<div id="life" class="off">
					...
					<div class="box">
						...
						<div class="con3">
							<div>
								<a href="http://www.dangjin.go.kr/job.do" target="_blank" title="새창열림"><img src="/images/kor/new_main/con3_banner01.jpg" alt="일자리종합지원센터" /></a>
							</div>
						</div>
						<!-- //배너 -->
	  ...
	  <div id="conD">
		<div class="layout">
			...
			<div class="ti">
				<h2>
				<a href="https://www.dangjin.go.kr/media/Main" target="_blank" title="새창열림">
			...
			<ul class="link">
				...
				<li><a href="#" target="_blank" title="새창열림" class="sns_ico ico5">kakao</a></li>
				<li><a href="#" target="_blank" title="새창열림" class="sns_ico ico6">youtube</a></li>
			</ul>
		</div>
	...
	<!--</div> -->
	  ...
	  <footer id="footer">
		 ...
		 <div class="layout">
			...
			<p class="mark">
					<img src="/images/kor/new_common/wa_mk.jpg" alt="과학기술정보통신부 WEB ACCESSIBILITY 마크(웹 접근성 품질인증 마크)">
			</p>
	...
	$(function(){
		setTimeout(function(){
			...
			$('#slider_banner .control .act').click(function(){
				...
				($(this).hasClass('stop')) ? $('#slider_banner .grep .obj').slick('slickPause') : $('#slider_banner .grep .obj').slick('slickPlay');
