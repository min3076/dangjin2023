			...
			<div>
				...
				<div id="civil" class="off">
					...
					<div class="box">
						...
						<div class="con3">
							<div>
								<a href="http://www.dangjin.go.kr/job.do" target="_blank" title="새창열림"><img src="/images/kor/new_main/con2_banner01.jpg" alt="당진시 일자리종합지원센터, 잡아라 JOB, 다양한 일자리정보 및 취업지원서비스 제공, 바로가기" /></a>
							</div>
						</div>
						...
						<div class="con2">
							<div>
								...
								<ul>
									...
									<li class="ico2"><a href="/kor/sub03_03_03.do">입찰정보</a></li>
									<li class="ico3"><a href="/kor/sub05_03_01_02.do">기업지원정보</a></li>
								</ul>
								<div class="table">
									<div class="table-row">
										<a href="https://www.dangjin.go.kr/job.do" target="_blank" title="새창열림" class="table-col">일자리종합지원센터</a>
										<a href="/prog/giftCertificate/kor/sub05_06_11_03/list.do" class="table-col">당진사랑상품권</a>
									</div>
									<div class="table-row">
										<a href="/cop/bbs/BBSMSTR_000000000571/selectBoardList.do" target="_blank" title="새창열림" class="table-col">채용행사</a>
										<a href="/prog/saleGood/kor/sub05_06_07/list.do" class="table-col">착한가격업소</a>
									</div>
								</div>
							</div>
						</div>
			  ...
			  <div id="mboard">
				 <div class="mboard-wrap">
					...
					<div class="mboardbox">
					   ...
					   <strong><a href="/prog/soapClient/kor/sub03_03_01_01/list.do">고시공고</a></strong>
					   <div id="mboard-3" class="grap">
						  <div class="more"><a href="/prog/soapClient/kor/sub03_03_01_01/list.do"><span class="skip">고시공고</span>더보기</a></div>
					   </div>
