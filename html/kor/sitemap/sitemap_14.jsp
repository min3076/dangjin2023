...
<div class="ui uit email">
	<div class="inner">
        <div class="txtwrap">
            <strong class="tit_inner">이메일무단수집거부</strong>
            <p>
            	본 홈페이지에 게시된 이메일 주소가 전자우편 수집 프로그램이나 그 밖의 기술적 장치를 이용하여 무단으로 수집되는 것을 거부하며, 
            	<b>이를 위반시 정보통신망이용촉진및정보보호등에관한법률 제50조의 2 규정에 의하여 1천만원이하의 벌금형에 처함을 유념하시기 바랍니다.</b>
            </p>
        </div>            
    </div>    
</div>

<h2>정보통신망법 제50조의2 (전자우편주소의 무단 수집행위 등 금지)</h2>
<ul class="list_1st">
