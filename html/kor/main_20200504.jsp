...
<script type="text/javascript">
 ...
 <style>
	...
	#popup{position:absolute;top:147px;margin-right:-189px;right:50%;width:576px;height:836px;background:#3d3d3d; color:#fff; text-align:center;
	border:2px solid #000;z-index: 20006;}
	#popup .popup_box{width:100%;height:738px;}
	#popup .popup_box a{width:100%;height:auto;display:block;}
 ...
 @media all and (max-width:799px){
	...
	#popup{width:80%;height:auto;margin-right:-41%;}
	#popup .popup_box{height:auto;}
 }
...
<div id="popup">
	<div class="popup_box">
		 <a href="/cop/bbs/BBSMSTR_000000000013/selectBoardArticle.do?nttId=1062817"><img src="/images/kor/new_main/popup01.jpg" usemap="#Map20170904" border="0" /></a>
		 <a href="/cop/bbs/BBSMSTR_000000000013/selectBoardArticle.do?nttId=1063388"><img src="/images/kor/new_main/popup02.jpg" usemap="#Map20170904" border="0" /></a>
		 <a href="/cop/bbs/BBSMSTR_000000000013/selectBoardArticle.do?nttId=1063248"><img src="/images/kor/new_main/popup03.jpg" usemap="#Map20170904" border="0" /></a>
		<div class="close">
			<form name="pop_form">
						...
						<div class="con4">
							<div class="siteLink_inner">
								...
								<div class='autoplay'>		  	
									...
									<div class="ico10">
										<a href="/bokji/sub02_03_01.do" title="새창열림">아동친화도시</a>
									</div>
