...
<!--팝업창-->
<style type="text/css">
#popup{position:absolute;top:150px;left:150px;width:454px; height:auto; background:#3d3d3d; color:#fff; text-align:center;border:2px solid #000;z-index: 20006}
...
<div id="popup_wrap">
	...
	<!-- <div id="popup">
		<div class="popup_box">
			<a href="/viewer/skin/doc.html?fn=BBS_202109171144308950.pdf&rs=/viewer/result/BBSMSTR_000000000450/" target="_blank" title="새창열림">
			<img src="/images/common/main/popup_20210917.jpg" border="0" alt="당진시 폭력예방상담소가 제안하는 함께해서 행복한 추석" /></a>
