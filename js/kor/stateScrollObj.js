function stateScrollObj(param,obj,btn,interval,speed,viewSize,moreSize,dir,data,auto,hover,method,op1){
	...
	//console.log(">>> param : "+param.attr("id"));
	//param.find(".obj *").on("focus",function(){
	//var _objHtml = param.find(".obj").html();
	//});
	$("*").on("focus",function(){
		...
		if(_thisParam != undefined && _thisObj != undefined){
			...
			//var _returnBtn = $(this);
			//console.log(">>> _returnBtn : "+_returnBtn.attr("class"));
			param.find(".obj.focusIn").each(function(){
				//console.log(">>> 포커스 아웃");
				//obj.eq(0).find("a").focus();
				$(this).find("li").detach();
				setTimeout(function(){
			...
			//param.find(".obj").removeClass("focusIn");
		}
	});
