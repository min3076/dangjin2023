function menulocate(param,control,code,mno,siteCode,dir){
	...
	menu.array = function(){
		...
		$.each(nodes,function(a){
			...
			if(a == nodes.length-1){
				array[a+1] = [["Site Map","/"+siteCode+"/sitemap_11.do"]];
			}
	...
	menu.prevStr = "<a data-control=\"prev\" href=\""+menu.prevVal[1]+"\"><div><em>"+menu.prevVal[0]+"</em><span class=\"icon prev\"></span></div></a>";
	menu.nextStr = "<a data-control=\"next\" href=\""+menu.nextVal[1]+"\"><div><span class=\"icon next\"></span><em>"+menu.nextVal[0]+"</em></div></a>";
